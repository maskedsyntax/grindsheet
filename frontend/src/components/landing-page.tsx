...
// //       // Clear the password field only for login errors
// //       if (activeTab === "login") {
// //         setLoginData((prev) => ({
// //           ...prev,
...
// //                 </div>
// //                 <div className="ml-4 text-xs text-gray-400">grindsheet.js</div>
// //               </div>
...
// //                   understanding.
// //                   {/* Your progress is automatically saved and
// //                   visualized through statistics and charts. */}
// //                 </AccordionContent>
// //               </AccordionItem>

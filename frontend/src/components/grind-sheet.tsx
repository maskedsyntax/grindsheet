    ...
    return (
        <TooltipProvider>
            <div
                ...
                <header
                    className="sticky top-0 z-10 bg-white/60 dark:bg-gray-950/60 backdrop-blur-md border-b border-gray-200/50 dark:border-gray-800/50">
                    <div className="container mx-auto px-4 py-3 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div
                                className=" text-white dark:bg-white dark:text-black h-10 w-10 flex items-center justify-center rounded-lg font-bold text-xl">
                                <img
                    ...
                    {mobileMenuOpen && (
                        <div
                            className="md:hidden p-4 border-t border-gray-200/50 dark:border-gray-800/50 bg-white/60 dark:bg-gray-950/60 backdrop-blur-md">
                ...
                <main className="container mx-auto px-4 py-6 flex-grow">
                    <div className="grid gap-6">
                        ...
                        <Card
                            className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-950 dark:to-indigo-950 border-0 shadow-xl shadow-blue-100/50 dark:shadow-blue-950/50">
                            {/* Background decoration */}
                            <div
                                className="absolute inset-0 bg-gradient-to-br from-white/60 to-transparent dark:from-white/5 dark:to-transparent"/>
                            <div
                                className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-blue-200/30 to-transparent dark:from-blue-400/10 rounded-full -translate-y-16 translate-x-16"/>
                            <div
                                className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-indigo-200/30 to-transparent dark:from-indigo-400/10 rounded-full translate-y-12 -translate-x-12"/>
                      ...
                      <span
                        ...
                        / {progressStats.total.total}
                                    ...
                                    <div className="relative">
                                        ...
                                        />
                                        <div
                                            className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 rounded-full"/>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
                                    {/* Easy */}
                                    <div
                                        className="group space-y-3 p-4 rounded-2xl bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border border-green-200/50 dark:border-green-800/50 hover:shadow-lg hover:shadow-green-100/50 dark:hover:shadow-green-900/20 transition-all duration-300">
                                        <div className="flex justify-between items-center">
                                            <Badge
                                                variant="outline"
                        ...
                        {progressStats.easy.solved}/{progressStats.easy.total}
                                        ...
                                        <div className="relative">
                                            ...
                                            />
                                            <div
                                                className="absolute inset-0 bg-gradient-to-r from-green-400/30 to-emerald-400/30 rounded-full"/>
                                        </div>
                      ...
                      <span className="text-xs font-medium text-green-600 dark:text-green-400">
                        {progressStats.easy.total > 0
                          ...
                          % Complete
                                            ...
                                            <div
                                                className="w-2 h-2 bg-green-400 rounded-full group-hover:scale-125 transition-transform duration-300"/>
                                        </div>
                                    </div>

                                    {/* Medium */}
                                    <div
                                        className="group space-y-3 p-4 rounded-2xl bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border border-yellow-200/50 dark:border-yellow-800/50 hover:shadow-lg hover:shadow-yellow-100/50 dark:hover:shadow-yellow-900/20 transition-all duration-300">
                                        <div className="flex justify-between items-center">
                                            <Badge
                                                variant="outline"
                      ...
                      <span className="text-xs font-medium text-yellow-600 dark:text-yellow-400">
                        {progressStats.medium.total > 0
                          ...
                          % Complete
                                            ...
                                            <div
                                                className="w-2 h-2 bg-yellow-400 rounded-full group-hover:scale-125 transition-transform duration-300"/>
                                        </div>
                                    </div>

                                    {/* Hard */}
                                    <div
                                        className="group space-y-3 p-4 rounded-2xl bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border border-red-200/50 dark:border-red-800/50 hover:shadow-lg hover:shadow-red-100/50 dark:hover:shadow-red-900/20 transition-all duration-300">
                                        <div className="flex justify-between items-center">
                                            <Badge
                                                variant="outline"
                        ...
                        {progressStats.hard.solved}/{progressStats.hard.total}
                                        ...
                                        <div className="relative">
                                            ...
                                            />
                                            <div
                                                className="absolute inset-0 bg-gradient-to-r from-red-400/30 to-rose-400/30 rounded-full"/>
                                        </div>
                                        <div className="flex items-center justify-between">
                      <span className="text-xs font-medium text-red-600 dark:text-red-400">
                        {progressStats.hard.total > 0
                          ...
                          % Complete
                                            ...
                                            <div
                                                className="w-2 h-2 bg-red-400 rounded-full group-hover:scale-125 transition-transform duration-300"/>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <Card
                                    className="bg-white/80 backdrop-blur-sm border-gray-200/60 shadow-lg dark:bg-gray-900/80 dark:border-gray-700/60">
                                    ...
                                    Difficulty
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="space-y-4">
                                                    <div
                                                        className="flex items-center justify-between p-3 rounded-lg bg-gray-50/80 dark:bg-gray-800/80">
                                                        <div className="flex items-center gap-3">
                                                            <Tag className="h-4 w-4 text-blue-600"/>
                                                            <Label
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <TooltipProvider>
                                                                                <Tooltip>
                                                                                    ...
                                                                                    >
                                                                                        <div
                                                                                            className="flex flex-wrap gap-1 max-w-[300px]">

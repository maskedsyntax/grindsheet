...
// //             </div>
// //             <div>
// //               <h1 className={`text-xl font-bold ${jetBrainsMono.className}`}>
// //                 GrindSheet
// //               </h1>
...
// //           <DialogHeader>
// //             <DialogTitle>
// //               {notesMap.has(currentProblemForNotes)
// //                 ? "Edit Notes"
// //                 : "Add Notes"}{" "}
// //               - {currentProblemForNotes}
// //             </DialogTitle>
// //           </DialogHeader>
// //           <div className="py-4">
// //             <Textarea
...
//     const fetchData = async () => {
//       try {
//         // Fetch data from the correct public path
//         const response = await fetch("/assets/data/gsheet_data.json");
